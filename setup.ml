...
(* OASIS_START *)
(* DO NOT EDIT (digest: e092b2f25ef38729ec56334e1cfd085a) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("sh", ["run_tests.sh"]))];
            ...
            [
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("variantslib.syntax", None);
                           FindlibPackage ("enumerate.syntax", None)
                        ];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "matkit.ml"});
               Executable
                 ({
                     cs_name = "test_typing";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test_typing.ml"});
               Executable
                 ({
                     cs_name = "test_parsing";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "test_parsing.ml"});
               Executable
                 ({
                     cs_name = "test_decl";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test_decl.ml"});
               Executable
                 ({
                     cs_name = "test_exp";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test_exp.ml"});
               Test
                 ({
                     cs_name = "all";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "ŒU}”|~Ò»\b©n“Xw3a";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
